...
class naivebayes(object):
    ...
    def predict(self, file_dictionary, number, ham_dictionary, spam_dictionary):
        """
        ...
        if ham_probability > spam_probability :
            print "this is a ham file"
            return 1
        else :
            print "this is a spam file"
            return 0
        
    def count(self, files_path, number, ham_dictionary, spam_dictionary):
        """
        count the PRECISION of naive bayes
        ...
        for file in files:
            ...
            result = self.predict(file_dictionary, number, ham_dictionary, spam_dictionary)
        ...
        print "PRECISION : %f" % (SPAM_NUMBER / TOTAL_NUMBER) 
